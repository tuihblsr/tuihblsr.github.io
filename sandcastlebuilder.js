...
BeachBall.ClickBeach = function(number) {
	if (Molpy.Got('Temporal Rift') == 0 && Molpy.ninjad != 0 && BeachBall.Time_to_ONG >= 5){
		Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();Molpy.ClickBeach();
	}
}
